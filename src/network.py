...
def network_v8_3(net, is_training=True, activation_fn=tf.nn.relu,
    ...
    with slim.arg_scope(network_arg_scope(is_training=is_training,
        ...
        pyr_inv = []
        for filt,x in zip(filts_sup,[64,32,16,8,4,2]):
        ...
        net = slim.conv2d(net,128,[3,1],stride=(2,1))
        ...
        net = slim.conv2d(net,256,[1,1],stride=(1,1))
